...
urlpatterns = [
    ...
    path("assessment/current/", views.current_assessment_view, name="current_assessment"),
    path(
        "assessment/<int:assessment_id>/delete/",
        views.delete_assessment,
        name="delete_assessment",
    ),
    path(
        "assessment/<int:assessment_id>/deleted/",
    ...
    path(
        "assessment/<int:assessment_id>/symptom/<int:symptom_item_id>/remove/",
