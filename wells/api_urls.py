...
urlpatterns = [
    ...
    path('deep-vein-thrombosis/<int:pk>/', api_views.RiskAssessmentDetailAPIView.as_view(),
         name='api_assessment_detail'),
    path('deep-vein-thrombosis/<int:pk>/update/', api_views.RiskAssessmentUpdateAPIView.as_view(),
         name='api_assessment_update'),
    path('deep-vein-thrombosis/<int:assessment_id>/form/', api_views.form_assessment, name='api_form_assessment'),
    path('deep-vein-thrombosis/<int:assessment_id>/complete/', api_views.complete_assessment,
         name='api_complete_assessment'),
